        ...
        <div className="lg:grid grid-cols-2 flex flex-col gap-4 lg:gap-3 ">
          ...
          <div>
            ...
            <input
              ...
              {...register("startDate", {
                ...
                validate: {
                  lessThanDueDate: (value) => {
                    const { dueDate } = getValues();
                    return dueDate
                      ? new Date(value) <= new Date(dueDate) ||
                          "Start date must be earlier than due date"
                      : true;
                  },
                },
              })}
          ...
          <div>
            ...
            <input
              ...
              {...register("estimatedTime", {
                required: "Estimated time is required",
                min: { value: 1, message: "Minimum value should be 1 hour" },
                max: {
                  value: 1000,
                  message: "Maximum value should be 1000 hours",
                },
...
taskDocuments"
            ...
            <input
              ...
              id="taskDocuments"
              {...register("taskDocuments", {
                required: "Task documents are required",
              })}
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            />
            {errors.taskDocuments && (
              <span className="text-red-500 text-sm">
                {errors.taskDocuments.message}
              </span>
            )}
          </div>
        </div>
